            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-3 text-sm text-[#1E1E1E] focus:border-[#100e09]"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="block w-full rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-3 text-sm text-[#1E1E1E] focus:border-[#100e09] cursor-pointer"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-2.5 text-xs text-[#1E1E1E] cursor-pointer"
                >
                ...
                {discountType !== 'none' && (
                  <input
                    ...
                    className="block w-24 rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-2.5 text-xs text-[#1E1E1E]"
                  />
                )}
              </div>
            </div>
            ...
            <div className="space-y-4 text-xs">
              <div>
                ...
                <textarea
                  ...
                  className="block w-full rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-2.5 text-xs text-[#1E1E1E] resize-y"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="block w-full rounded-lg border border-gray-200 bg-[#f5f4eb] py-2 px-2.5 text-xs text-[#1E1E1E] resize-y font-mono text-[10px]"
                />
              </div>
              ...
              <div>
                <label className="block font-semibold text-gray-555 mb-1 flex items-center space-x-1.5">
                  ...
                  <span className="text-[8px] font-bold text-[#100e09] bg-red-50 px-1 py-0.2 rounded uppercase font-semibold">Will not print</span>
                </label>
                <textarea
                  rows={2}
                  value={internalNote}
